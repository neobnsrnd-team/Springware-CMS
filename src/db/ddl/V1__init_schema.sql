...
-- 생성일: 2026-03-18
-- 최종 수정: 2026-03-23 (#80 MAP PK 변경, #74 RENDERED_HTML 제거)
--
-- ※ DBeaver 실행 방법:
...
-- ──────────────────────────────────────────────────────────────────────────
-- 2-1. SPW_CMS_PAGE_HISTORY — 페이지 버전 이력
...
COMMENT ON TABLE  SPW_CMS_PAGE_HISTORY                     IS 'CMS 페이지 변경 이력 — 승인 시 PAGE 스냅샷 저장 [Springware CMS 신규]';
COMMENT ON COLUMN SPW_CMS_PAGE_HISTORY.VERSION             IS '이력 버전 번호 (승인 시마다 +1)';
...
COMMENT ON COLUMN SPW_CMS_COMP_PAGE_MAP.VERSION            IS '페이지 버전 (PAGE_HISTORY.VERSION 참조)';
...
CREATE INDEX IDX_SPW_COMP_MAP_PAGE
    ON SPW_CMS_COMP_PAGE_MAP (PAGE_ID, VERSION, SORT_ORDER);
