// 금융 도메인 컴포넌트 — 웹(데스크톱) 최적화 버전
// 모바일 버전과 동일한 data-cb-type, CSS 클래스 접두사를 사용하며,
// 최상위 div에 web-layout 클래스를 추가하여 플러그인 CSS가 레이아웃을 구분할 수 있도록 함

import type { FinanceComponent } from './finance-component-data';

export const FINANCE_COMPONENTS_WEB: FinanceComponent[] = [
    {
        id: 'app-header',
        viewMode: 'web',
        label: '최상단 헤더 (웹)',
        description: '로고 + 수평 내비게이션 링크 (웹 전용)',
        preview: '/assets/minimalist-blocks/preview/ibk-app-header.svg',
        html: `
<div data-cb-type="app-header" class="web-layout">
    <div class="ah-inner" style="display:flex;align-items:center;justify-content:space-between;width:100%;max-width:1280px;margin:0 auto;padding:0 32px;">
        <a href="#" class="ah-logo">
            <img class="ah-logo-img" src="" alt="은행 로고" />
            <span class="ah-logo-text">IBK기업은행</span>
        </a>
        <nav class="ah-nav" style="display:flex;gap:24px;align-items:center;">
            <a href="#" class="ah-nav-link" style="color:inherit;text-decoration:none;font-size:15px;font-weight:500;">개인뱅킹</a>
            <a href="#" class="ah-nav-link" style="color:inherit;text-decoration:none;font-size:15px;font-weight:500;">기업뱅킹</a>
            <a href="#" class="ah-nav-link" style="color:inherit;text-decoration:none;font-size:15px;font-weight:500;">금융상품</a>
            <a href="#" class="ah-nav-link" style="color:inherit;text-decoration:none;font-size:15px;font-weight:500;">고객센터</a>
            <a href="#" class="ah-nav-link" style="color:inherit;text-decoration:none;font-size:15px;font-weight:500;">마이페이지</a>
        </nav>
    </div>
</div>
`,
    },
    {
        ...
        viewMode: 'web',
        label: '금융 상품 갤러리 (웹)',
        description: '예금·적금·대출 3열 그리드 카드',
        preview: '/assets/minimalist-blocks/preview/ibk-product-gallery.svg',
        html: `
<div data-cb-type="product-gallery" class="web-layout">
    <div class="pg-header">
        <h3 class="pg-title">주요 금융상품</h3>
    </div>
    <div class="pg-track" style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;">
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '환율 및 금융 지수 (웹)',
        description: 'USD·EUR·JPY·CNY 실시간 환율 (전체 너비)',
        preview: '/assets/minimalist-blocks/preview/ibk-exchange-board.svg',
        html: `
<div data-cb-type="exchange-board" class="web-layout" style="width:100%;max-width:1280px;margin:0 auto;">
    <div class="eb-header">
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '영업점/ATM 위치 (웹)',
        description: '지도(좌) + 영업점 목록(우) 수평 배치',
        preview: '/assets/minimalist-blocks/preview/ibk-branch-locator.svg',
        html: `
<div data-cb-type="branch-locator" class="web-layout" style="display:flex;gap:0;width:100%;max-width:1280px;margin:0 auto;">
    <div class="bl-map-area" style="flex:0 0 60%;min-height:480px;">
    ...
    <div class="bl-sheet" style="flex:0 0 40%;overflow-y:auto;max-height:480px;">
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '홍보 배너 (웹)',
        description: '넓은 배너 + 큰 텍스트 슬라이드',
        preview: '/assets/minimalist-blocks/preview/ibk-promo-banner.svg',
        html: `
<div data-cb-type="promo-banner" class="web-layout">
    <div class="pb-banner-section" style="max-width:1280px;margin:0 auto;">
        <div class="pb-track">
            <div class="pb-slide" data-item-id="pb-1" style="aspect-ratio:21/9;">
                <div class="pb-slide-bg" style="background:linear-gradient(135deg,#0046A4 0%,#0066CC 100%)"></div>
                <div class="pb-slide-content" style="padding:48px 64px;">
                    <span class="pb-badge">이벤트</span>
                    <h3 class="pb-slide-title" style="font-size:32px;">특별 금리 혜택</h3>
                    <p class="pb-slide-desc" style="font-size:18px;">IBK 적금 가입 시 최고 4.5% 금리</p>
                    <a href="#" class="pb-slide-cta">자세히 보기</a>
                </div>
            </div>
            <div class="pb-slide" data-item-id="pb-2" style="aspect-ratio:21/9;">
                <div class="pb-slide-bg" style="background:linear-gradient(135deg,#FF6600 0%,#FF8C42 100%)"></div>
                <div class="pb-slide-content" style="padding:48px 64px;">
                    <span class="pb-badge">신상품</span>
                    <h3 class="pb-slide-title" style="font-size:32px;">기업 맞춤 대출</h3>
                    <p class="pb-slide-desc" style="font-size:18px;">중소기업 전용 최저 4.2% 특별 금리</p>
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '미디어 홍보 (웹)',
        description: '좌측 제목 + 우측 영상 수평 배치',
        preview: '/assets/minimalist-blocks/preview/ibk-media-video.svg',
        html: `
<div data-cb-type="media-video" class="web-layout" style="display:flex;align-items:center;gap:48px;max-width:1280px;margin:0 auto;padding:40px 32px;">
    <div class="mv-info" style="flex:0 0 35%;">
        <div class="mv-label" style="font-size:24px;font-weight:700;margin-bottom:16px;">IBK 소개 영상</div>
        <p class="mv-description" style="font-size:15px;color:#666;line-height:1.6;">IBK기업은행의 다양한 금융 서비스와 혁신적인 디지털 뱅킹 솔루션을 영상으로 만나보세요.</p>
    </div>
    <div class="mv-wrap" style="flex:1;">
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '금융 계산기 (웹)',
        description: '좌측 입력 + 우측 결과 2단 레이아웃',
        preview: '/assets/minimalist-blocks/preview/ibk-loan-calculator.svg',
        html: `
<div data-cb-type="loan-calculator" class="web-layout" style="max-width:1280px;margin:0 auto;">
    <div class="lc-tabs">
    ...
    <div class="lc-body" style="display:flex;gap:32px;align-items:flex-start;">
        <div style="flex:1;">
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '상품 메뉴 (웹)',
        description: '예금·대출·펀드 등 5열 그리드',
        preview: '/assets/minimalist-blocks/preview/ibk-product-menu.svg',
        html: `
<div data-cb-type="product-menu" class="web-layout">
    <div class="pm-header">
        <span class="pm-title edit">상품</span>
    </div>
    <div class="pm-grid" style="grid-template-columns:repeat(5,1fr);">
        ...
        <a href="#" class="pm-item">
            <div class="pm-icon-wrap"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg></div>
            <span class="pm-label edit">보안센터</span>
        </a>
    </div>
</div>
`,
    },
    {
        ...
        viewMode: 'web',
        label: '보안·인증센터 (웹)',
        description: '공동인증서·금융인증서·OTP·보안카드 2×2 그리드',
        preview: '/assets/minimalist-blocks/preview/ibk-auth-center.svg',
        html: `
<div data-cb-type="auth-center" class="web-layout" style="max-width:1280px;margin:0 auto;">
    <div class="ac-header">
        <h3 class="ac-title">인증센터</h3>
        <p class="ac-desc">안전한 금융거래를 위한 인증 서비스</p>
    </div>
    <div class="ac-cards" style="display:grid;grid-template-columns:repeat(2,1fr);gap:16px;">
...
`,
    },
    {
        ...
        viewMode: 'web',
        label: '사이트 푸터 (웹)',
        description: '다단 레이아웃 — 링크·연락처·SNS 수평 배치',
        preview: '/assets/minimalist-blocks/preview/ibk-site-footer.svg',
        html: `
<div data-cb-type="site-footer" class="web-layout">
    <div class="sf-inner" style="max-width:1280px;margin:0 auto;padding:40px 32px;">
        <div style="display:flex;gap:48px;margin-bottom:32px;">
            <div style="flex:1;">
                <div class="sf-links" style="display:flex;flex-wrap:wrap;gap:8px 0;">
                    ...
                    <a href="#" class="sf-link">상품공시실</a><span class="sf-sep">|</span>
                    <a href="#" class="sf-link">위치기반서비스 이용약관</a><span class="sf-sep">|</span>
                    <a href="#" class="sf-link">고객센터</a>
                </div>
            </div>
            <div style="flex:0 0 auto;text-align:center;">
                <p class="sf-contact edit" style="margin-bottom:4px;">국내1588-2588,1566-2566(보이스피싱신고 8번)</p>
                <p class="sf-contact edit">해외 82-31-888-800</p>
            </div>
            <div style="flex:0 0 auto;">
                <div class="sf-social" style="display:flex;gap:12px;">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;border-top:1px solid rgba(255,255,255,0.1);padding-top:20px;">
            ...
            <div class="sf-selects" style="display:flex;gap:12px;">
